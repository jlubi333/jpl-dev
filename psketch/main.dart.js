...
["dart.async", "dart:async", , P, {
  ...
  }, null, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 7, 29],
  ...
  _BroadcastSubscription: {
    "^": "_ControllerSubscription;_eventState,_next@,_previous?,_async$_controller,_async$_onData,_onError,_onDone,_zone,_state,_cancelFuture,_pending",
  ...
  _BroadcastStreamController: {
    ...
    }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 6, 29],
    close$0: function(_) {
      var doneFuture;
      if ((this._state & 4) !== 0)
  ...
  _Future: {
    ...
    }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 7, 29],
...
["dart.collection", "dart:collection", , P, {
  ...
  SetMixin: {
    ...
    containsAll$1: function(other) {
      var t1;
      for (t1 = new P.LinkedHashSetIterator(other, other._collection$_modifications, null, null), t1._collection$_cell = other._collection$_first; t1.moveNext$0();)
...
["dart.dom.html", "dart:html", , W, {
  ...
  Element: {
    ...
    }, "createFragment$2$treeSanitizer", null, null, "get$createFragment", 2, 5, null, 29, 29],
  ...
  InputElement: {
    "^": "HtmlElement;disabled},height%,name=,value%,valueAsNumber=,width%",
    $isElement: 1,
    $isInterceptor: 1,
    "%": "HTMLInputElement"
  },
...
["", "main.dart", , F, {
  ...
  solve: function(r) {
    var t1, t2, other, t3;
    for (t1 = $.get$RELATION_DATABASE().get$keys()._map, t2 = new H.LinkedHashMapKeyIterator(t1, t1._modifications, null, null), t2._cell = t1._first, t1 = r.result; t2.moveNext$0();) {
      other = t2.__js_helper$_current;
      t3 = J.get$result$x(other);
      if ((t1 == null ? t3 == null : t1 === t3) && r.dependencies.intersection$1(other.get$dependencies()).containsAll$1(other.dependencies))
        return $.get$RELATION_DATABASE().$index(0, other).call$0();
    }
    return;
  },
  calculate: function() {
    var t1, ie, t2, t3, selectedRadio, numericalResult, result, $status;
    for (t1 = $.inputs, t1 = t1.get$iterator(t1); t1.moveNext$0();) {
      ie = t1._current;
      t2 = J.getInterceptor$x(ie);
      $.get$V().$indexSet(0, t2.get$id(ie), t2.get$valueAsNumber(ie));
    }
    if (J.get$isNaN$n($.get$V().$index(0, "x")))
      t1 = !(J.get$isNaN$n($.get$V().$index(0, "y")) || J.get$isNaN$n($.get$V().$index(0, "z")));
    else
      t1 = false;
    if (t1) {
      t1 = $.get$V();
      ...
      H.checkNum(t3);
      H.checkNum(2);
      t1.$indexSet(0, "x", Math.sqrt(H.checkNum(t2 - Math.pow(t3, 2))));
    } else {
      if (J.get$isNaN$n($.get$V().$index(0, "y")))
        t1 = !(J.get$isNaN$n($.get$V().$index(0, "x")) || J.get$isNaN$n($.get$V().$index(0, "z")));
      else
        t1 = false;
      if (t1) {
        t1 = $.get$V();
        ...
        H.checkNum(t3);
        H.checkNum(2);
        t1.$indexSet(0, "y", Math.sqrt(H.checkNum(t2 - Math.pow(t3, 2))));
      } else {
        if (J.get$isNaN$n($.get$V().$index(0, "z")))
          t1 = !(J.get$isNaN$n($.get$V().$index(0, "x")) || J.get$isNaN$n($.get$V().$index(0, "y")));
        else
          t1 = false;
        if (t1) {
          t1 = $.get$V();
          ...
          H.checkNum(t3);
          H.checkNum(2);
          t1.$indexSet(0, "z", Math.sqrt(H.checkNum(t2 + Math.pow(t3, 2))));
        }
      }
    }
    selectedRadio = document.querySelector("#rateSelectors input[type=radio]:checked");
    if (selectedRadio != null) {
      t1 = J.get$value$x(selectedRadio);
      t2 = $.get$V().get$keys();
      t1 = new F.Relationship(t1, null);
      t1.dependencies = P.LinkedHashSet_LinkedHashSet$from(H.setRuntimeTypeInfo(new H.WhereIterable(t2, new F.calculate_closure()), [H.getRuntimeTypeArgument(t2, "IterableBase", 0)]), null);
      numericalResult = F.solve(t1);
      if (numericalResult != null && J.get$isFinite$n(numericalResult)) {
        t1 = J.get$innerHtml$x(J.get$children$x(selectedRadio.parentElement).$index(0, 0));
        if (t1 == null)
          return t1.$add();
        t1 += " is ";
        if (typeof numericalResult !== "number")
          return H.iae(numericalResult);
        result = t1 + C.JSDouble_methods.toString$0(C.JSNumber_methods.round$0(1000 * numericalResult) / 1000);
        $status = "success";
      } else {
        result = "Not solvable.";
        $status = "error";
    ...
    J.set$innerHtml$x($.output, result);
    $.output.className = $status;
  },
  isTriangleLeft: function() {
    var t1, t2;
    t1 = $.triangleCoords;
    if (1 >= t1.length)
      return H.ioore(t1, 1);
    ...
    if (typeof t2 !== "number")
      return t2.$div();
    return J.$lt$n(t1, t2 / 2);
  },
  isTriangleBottom: function() {
    var t1, t2;
    t1 = $.triangleCoords;
    if (1 >= t1.length)
      return H.ioore(t1, 1);
    ...
    if (typeof t2 !== "number")
      return t2.$div();
    return J.$gt$n(t1, t2 / 2);
  },
  flipTriangleX: function() {
    var t1, amount, t2, t3;
    t1 = $.xFlipped;
    amount = (t1 ? -1 : 1) * 160 * 2;
    t2 = $.interpolateCoords;
    t3 = t2[0];
    t3[1] = t3[1] + amount;
    t3 = t2[1];
    t3[1] = t3[1] - amount;
  ...
  centerTriangle: function() {
    var t1, centerX, centerY, t2, i, j;
    $.xFlipped = false;
    $.yFlipped = false;
    ...
    t1 = centerX + 160;
    t2 = centerY + 160;
    t2 = [[t1, centerY - 160], [t1, t2], [centerX - 160, t2]];
    $.interpolateCoords = t2;
    $.triangleCoords = [];
    for (t1 = t2, i = 0; t1.length, i < 3; ++i) {
      $.triangleCoords.push([]);
      for (j = 0; t1 = $.interpolateCoords, t2 = t1[i], j < 2; ++j) {
        t1 = $.triangleCoords;
        if (i >= t1.length)
          return H.ioore(t1, i);
        J.add$1$ax(t1[i], t2[j]);
      }
    }
    t1 = $.triangleCoords;
    if (0 >= t1.length)
      return H.ioore(t1, 0);
    t1 = J.$sub$n(J.$index$asx(t1[0], 0), 160);
    t2 = $.xs;
    t2.toString;
    $.xsLeft = J.$sub$n(t1, C.JSNumber_methods.round$0(t2.clientWidth) / 2);
    t2 = $.triangleCoords;
    if (0 >= t2.length)
      return H.ioore(t2, 0);
    t2 = J.$add$ns(J.$index$asx(t2[0], 1), 160);
    t1 = $.ys;
    t1.toString;
    $.ysTop = J.$add$ns(t2, C.JSNumber_methods.round$0(t1.clientHeight) / 2);
  },
  resizeCanvas: function() {
    J.set$width$x($.canvas, window.innerWidth);
    J.set$height$x($.canvas, window.innerHeight);
  },
  interpolate: function(delta, speed, p1, p2) {
    var t1;
    if (typeof p1 !== "number")
      return H.iae(p1);
    t1 = Math.abs(p2 - p1);
    if (typeof delta !== "number")
      return H.iae(delta);
    if (t1 > speed * delta)
      return p1 + (p1 < p2 ? 1 : -1) * speed * delta;
    else
      return p2;
  },
  draw: [function(timestamp) {
    var t1, i, j, t2, t3, t4, t5;
    if (J.$eq($.previousTimestamp, 0)) {
      $.delta = timestamp;
      t1 = timestamp;
    } else {
      t1 = J.$sub$n(timestamp, $.previousTimestamp);
      $.delta = t1;
    }
    if (typeof t1 !== "number")
      return t1.$div();
    $.delta = t1 / 1000;
    J.set$fillStyle$x($.ctx, "#FFFFFF");
    J.set$strokeStyle$x($.ctx, "#000000");
    J.fillRect$4$x($.ctx, 0, 0, J.get$width$x($.canvas), J.get$height$x($.canvas));
    for (i = 0; i < $.triangleCoords.length; ++i) {
      ...
      while (true) {
        ...
        if (j >= 2)
          return H.ioore(t5, j);
        t3.$indexSet(t1, j, F.interpolate(t2, 300, t4, t5[j]));
        ++j;
      }
    }
    t1 = F.isTriangleLeft();
    ...
    if (t1) {
      if (0 >= t2.length)
        return H.ioore(t2, 0);
      t1 = J.$index$asx(t2[0], 0);
      t2 = $.ys;
      t2.toString;
      $.ysLeft = J.$sub$n(J.$sub$n(t1, C.JSNumber_methods.round$0(t2.clientWidth)), 10);
      t2 = J.get$width$x($.canvas);
      if (typeof t2 !== "number")
        return t2.$div();
      $.zsLeft = t2 / 2 + 10;
      ...
      if (2 >= t2.length)
        return H.ioore(t2, 2);
      t2 = J.$index$asx(t2[2], 0);
      t1 = $.thetas;
      t1.toString;
      $.thetasLeft = J.$sub$n(J.$sub$n(t2, C.JSNumber_methods.round$0(t1.clientWidth)), 70);
    } else {
      if (0 >= t2.length)
        return H.ioore(t2, 0);
      $.ysLeft = J.$add$ns(J.$index$asx(t2[0], 0), 10);
      t1 = J.get$width$x($.canvas);
      if (typeof t1 !== "number")
        return t1.$div();
      t2 = $.zs;
      t2.toString;
      $.zsLeft = t1 / 2 - C.JSNumber_methods.round$0(t2.clientWidth) - 10;
      t2 = $.triangleCoords;
      if (2 >= t2.length)
        return H.ioore(t2, 2);
      $.thetasLeft = J.$add$ns(J.$index$asx(t2[2], 0), 55);
    }
    t1 = F.isTriangleBottom();
    t2 = $.triangleCoords;
    if (t1) {
      if (1 >= t2.length)
        return H.ioore(t2, 1);
      $.xsTop = J.$add$ns(J.$index$asx(t2[1], 1), 10);
      t1 = J.get$height$x($.canvas);
      if (typeof t1 !== "number")
        return t1.$div();
      t2 = $.zs;
      t2.toString;
      $.zsTop = t1 / 2 - C.JSNumber_methods.round$0(t2.clientHeight);
      t2 = $.triangleCoords;
      if (1 >= t2.length)
        return H.ioore(t2, 1);
      ...
      t1 = $.thetas;
      t1.toString;
      $.thetasTop = J.$sub$n(t2, C.JSNumber_methods.round$0(t1.clientHeight));
    } else {
      if (1 >= t2.length)
        return H.ioore(t2, 1);
      t1 = J.$index$asx(t2[1], 1);
      t2 = $.xs;
      t2.toString;
      $.xsTop = J.$sub$n(J.$sub$n(t1, C.JSNumber_methods.round$0(t2.clientHeight)), 10);
      t2 = J.get$height$x($.canvas);
      if (typeof t2 !== "number")
        return t2.$div();
      $.zsTop = t2 / 2;
      ...
      if (1 >= t2.length)
        return H.ioore(t2, 1);
      $.thetasTop = J.$add$ns(J.$index$asx(t2[1], 1), 10);
    }
    J.set$left$x($.xs.style, J.toString$0($.xsLeft) + "px");
    J.set$top$x($.xs.style, J.toString$0($.xsTop) + "px");
    J.set$left$x($.ys.style, J.toString$0($.ysLeft) + "px");
    J.set$top$x($.ys.style, J.toString$0($.ysTop) + "px");
    J.set$left$x($.zs.style, J.toString$0($.zsLeft) + "px");
    J.set$top$x($.zs.style, J.toString$0($.zsTop) + "px");
    J.set$left$x($.thetas.style, J.toString$0($.thetasLeft) + "px");
    J.set$top$x($.thetas.style, J.toString$0($.thetasTop) + "px");
    t1 = $.ctx;
    J.beginPath$0$x(t1);
    t2 = $.triangleCoords;
    if (0 >= t2.length)
      return H.ioore(t2, 0);
    t2 = J.$index$asx(t2[0], 0);
    t3 = $.triangleCoords;
    if (0 >= t3.length)
      return H.ioore(t3, 0);
    t1.moveTo(t2, J.$index$asx(t3[0], 1));
    t3 = $.triangleCoords;
    if (1 >= t3.length)
      return H.ioore(t3, 1);
    ...
    if (1 >= t2.length)
      return H.ioore(t2, 1);
    t1.lineTo(t3, J.$index$asx(t2[1], 1));
    t2 = $.triangleCoords;
    if (2 >= t2.length)
      return H.ioore(t2, 2);
    t2 = J.$index$asx(t2[2], 0);
    ...
    if (2 >= t3.length)
      return H.ioore(t3, 2);
    t1.lineTo(t2, J.$index$asx(t3[2], 1));
    t1.closePath();
    t1.stroke();
    t1 = $.triangleCoords;
    if (2 >= t1.length)
      return H.ioore(t1, 2);
    t1 = J.$index$asx(t1[2], 0);
    t3 = $.triangleCoords;
    if (1 >= t3.length)
      return H.ioore(t3, 1);
    t3 = J.abs$0$n(J.$sub$n(t1, J.$index$asx(t3[1], 0)));
    if (typeof t3 !== "number")
      return t3.$div();
    t3 /= 16;
    $.angleArcRadius = t3;
    if (t3 !== 0) {
      ...
      if (2 >= t1.length)
        return H.ioore(t1, 2);
      $.angleArcX = J.$index$asx(t1[2], 0);
      t1 = $.triangleCoords;
      if (2 >= t1.length)
        return H.ioore(t1, 2);
      $.angleArcY = J.$index$asx(t1[2], 1);
      t1 = $.triangleCoords;
      if (1 >= t1.length)
        return H.ioore(t1, 1);
      t1 = J.$index$asx(t1[1], 1);
      ...
      if (0 >= t2.length)
        return H.ioore(t2, 0);
      t2 = J.$sub$n(t1, J.$index$asx(t2[0], 1));
      t1 = $.triangleCoords;
      if (2 >= t1.length)
        return H.ioore(t1, 2);
      t1 = J.$index$asx(t1[2], 0);
      ...
      if (1 >= t3.length)
        return H.ioore(t3, 1);
      t3 = J.$sub$n(t1, J.$index$asx(t3[1], 0));
      if (typeof t2 !== "number")
        return t2.$div();
      if (typeof t3 !== "number")
        return H.iae(t3);
      $.angleArcEndAngle = Math.atan(H.checkNum(t2 / t3));
      if (F.isTriangleLeft()) {
        $.angleArcStartAngle = 3.141592653589793;
        t1 = $.angleArcEndAngle;
        if (typeof t1 !== "number")
          return t1.$add();
        $.angleArcEndAngle = t1 + 3.141592653589793;
        $.angleArcAnticlockwise = false;
      } else {
        $.angleArcStartAngle = 0;
        $.angleArcAnticlockwise = true;
      }
      if (!F.isTriangleBottom())
        $.angleArcAnticlockwise = $.angleArcAnticlockwise !== true;
      J.beginPath$0$x($.ctx);
      J.arc$6$x($.ctx, $.angleArcX, $.angleArcY, $.angleArcRadius, $.angleArcStartAngle, $.angleArcEndAngle, $.angleArcAnticlockwise);
      J.stroke$0$x($.ctx);
    }
    $.previousTimestamp = timestamp;
    C.Window_methods.get$animationFrame(window).then$1(F.draw$closure());
  }, "call$1", "draw$closure", 2, 0, 28],
  main: [function() {
    var radios, t1;
    $.inputs = new W._FrozenElementList(document.querySelectorAll("#controls input[type=number]"));
    $.output = document.querySelector("#output");
    radios = new W._FrozenElementList(document.querySelectorAll("#rateSelectors input[type=radio]"));
    radios.forEach$1(radios, new F.main_closure());
    for (t1 = $.inputs, t1 = t1.get$iterator(t1); t1.moveNext$0();)
      J.get$onKeyDown$x(t1._current).listen$1(new F.main_closure0());
    t1 = J.get$onClick$x(document.querySelector("#calculate"));
    ...
    $.canvas = document.querySelector("#triangle");
    F.resizeCanvas();
    ...
    t1 = J.get$onClick$x(document.querySelector("#flipX"));
    ...
    t1 = J.get$onClick$x(document.querySelector("#flipY"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure5()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    $.xs = document.querySelector("#xs");
    $.ys = document.querySelector("#ys");
    $.zs = document.querySelector("#zs");
    t1 = document.querySelector("#thetas");
    $.thetas = t1;
    C.JSArray_methods.forEach$1([$.xs, $.ys, $.zs, t1], new F.main_closure6());
    F.centerTriangle();
    C.Window_methods.get$animationFrame(window).then$1(F.draw$closure());
  ...
  closure: {
    ...
    call$0: function() {
      var t1, t2, t3;
      t1 = J.$add$ns(J.$mul$ns($.get$V().$index(0, "x"), $.get$V().$index(0, "d___x")), J.$mul$ns($.get$V().$index(0, "y"), $.get$V().$index(0, "d___y")));
      t2 = $.get$V().$index(0, "x");
      H.checkNum(t2);
      H.checkNum(2);
      t2 = Math.pow(t2, 2);
      ...
      H.checkNum(t3);
      H.checkNum(2);
      t3 = Math.sqrt(H.checkNum(t2 + Math.pow(t3, 2)));
      if (typeof t1 !== "number")
        return t1.$div();
      return t1 / t3;
    }
  ...
  closure0: {
    ...
    call$0: function() {
      var t1, t2, t3;
      t1 = J.$sub$n(J.$mul$ns($.get$V().$index(0, "z"), $.get$V().$index(0, "d___z")), J.$mul$ns($.get$V().$index(0, "x"), $.get$V().$index(0, "d___x")));
      t2 = $.get$V().$index(0, "z");
      H.checkNum(t2);
      H.checkNum(2);
      t2 = Math.pow(t2, 2);
  ...
  closure1: {
    ...
    call$0: function() {
      var t1, t2, t3;
      t1 = J.$sub$n(J.$mul$ns($.get$V().$index(0, "z"), $.get$V().$index(0, "d___z")), J.$mul$ns($.get$V().$index(0, "y"), $.get$V().$index(0, "d___y")));
      t2 = $.get$V().$index(0, "z");
      H.checkNum(t2);
      H.checkNum(2);
      t2 = Math.pow(t2, 2);
  ...
  closure2: {
    ...
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = Math.sin(H.checkNum($.get$V().$index(0, "theta")));
      t2 = $.get$V().$index(0, "d___y");
      if (typeof t2 !== "number")
        return H.iae(t2);
      t3 = J.$mul$ns(J.$mul$ns($.get$V().$index(0, "y"), Math.cos(H.checkNum($.get$V().$index(0, "theta")))), $.get$V().$index(0, "d___theta"));
      if (typeof t3 !== "number")
        return H.iae(t3);
      t4 = Math.sin(H.checkNum($.get$V().$index(0, "x")));
      H.checkNum(t4);
      H.checkNum(2);
      return (t1 * t2 - t3) / Math.pow(t4, 2);
    }
  },
  closure3: {
    "^": "Closure:0;",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = J.$mul$ns($.get$V().$index(0, "d___z"), Math.sin(H.checkNum($.get$V().$index(0, "theta"))));
      t2 = Math.cos(H.checkNum($.get$V().$index(0, "theta")));
      t3 = $.get$V().$index(0, "d___theta");
      if (typeof t3 !== "number")
        return H.iae(t3);
      t4 = $.get$V().$index(0, "z");
      if (typeof t4 !== "number")
        return H.iae(t4);
      return J.$add$ns(t1, t2 * t3 * t4);
    }
  },
  closure4: {
    "^": "Closure:0;",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = J.$sub$n(J.$mul$ns($.get$V().$index(0, "z"), $.get$V().$index(0, "d___y")), J.$mul$ns($.get$V().$index(0, "y"), $.get$V().$index(0, "d___z")));
      t2 = $.get$V().$index(0, "z");
      H.checkNum(t2);
      H.checkNum(2);
      t2 = Math.pow(t2, 2);
      ...
      H.checkNum(t4);
      H.checkNum(2);
      t4 = Math.sqrt(H.checkNum(1 - Math.pow(t4, 2)));
      if (typeof t1 !== "number")
        return t1.$div();
      return t1 / (t2 * t4);
    }
  ...
  closure5: {
    ...
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = Math.cos(H.checkNum($.get$V().$index(0, "theta")));
      t2 = $.get$V().$index(0, "d___x");
      if (typeof t2 !== "number")
        return H.iae(t2);
      t3 = J.$mul$ns(J.$mul$ns($.get$V().$index(0, "x"), -Math.cos(H.checkNum($.get$V().$index(0, "theta")))), $.get$V().$index(0, "d___theta"));
      if (typeof t3 !== "number")
        return H.iae(t3);
      t4 = Math.cos(H.checkNum($.get$V().$index(0, "x")));
      H.checkNum(t4);
      H.checkNum(2);
      return (t1 * t2 - t3) / Math.pow(t4, 2);
    }
  ...
  closure6: {
    ...
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = J.$mul$ns($.get$V().$index(0, "d___z"), Math.cos(H.checkNum($.get$V().$index(0, "theta"))));
      t2 = Math.cos(H.checkNum($.get$V().$index(0, "theta")));
      t3 = $.get$V().$index(0, "d___theta");
      if (typeof t3 !== "number")
        return H.iae(t3);
  ...
  closure7: {
    ...
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = J.$sub$n(J.$mul$ns($.get$V().$index(0, "z"), $.get$V().$index(0, "d___x")), J.$mul$ns($.get$V().$index(0, "x"), $.get$V().$index(0, "d___z")));
      t2 = $.get$V().$index(0, "z");
      H.checkNum(t2);
      H.checkNum(2);
      t2 = Math.pow(t2, 2);
  ...
  closure8: {
    ...
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = Math.tan(H.checkNum($.get$V().$index(0, "theta")));
      t2 = $.get$V().$index(0, "d___y");
      if (typeof t2 !== "number")
        return H.iae(t2);
      t3 = $.get$V().$index(0, "y");
      t4 = 1 / Math.cos(H.checkNum($.get$V().$index(0, "theta")));
      H.checkNum(t4);
      H.checkNum(2);
      t4 = J.$mul$ns(J.$mul$ns(t3, Math.pow(t4, 2)), $.get$V().$index(0, "d___theta"));
      if (typeof t4 !== "number")
        return H.iae(t4);
      t3 = Math.tan(H.checkNum($.get$V().$index(0, "theta")));
      H.checkNum(t3);
      H.checkNum(2);
      return (t1 * t2 - t4) / Math.pow(t3, 2);
    }
  },
  closure9: {
    "^": "Closure:0;",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = J.$mul$ns($.get$V().$index(0, "d___x"), Math.tan(H.checkNum($.get$V().$index(0, "theta"))));
      t2 = Math.cos(H.checkNum($.get$V().$index(0, "theta")));
      H.checkNum(t2);
      H.checkNum(2);
      t2 = Math.pow(t2, 2);
  ...
  closure10: {
    ...
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = J.$sub$n(J.$mul$ns($.get$V().$index(0, "x"), $.get$V().$index(0, "d___y")), J.$mul$ns($.get$V().$index(0, "y"), $.get$V().$index(0, "d___x")));
      t2 = $.get$V().$index(0, "x");
      H.checkNum(t2);
      H.checkNum(2);
      t2 = Math.pow(t2, 2);
  ...
  calculate_closure: {
    "^": "Closure:4;",
    call$1: function(key) {
      return !J.get$isNaN$n($.get$V().$index(0, key));
    }
  },
  main_closure: {
    "^": "Closure:16;",
    call$1: function(radio) {
      return J.get$onClick$x(radio).listen$1(new F.main__closure(radio));
    }
  },
  main__closure: {
    "^": "Closure:17;radio_0",
    call$1: function(e) {
      var t1, disabledNumberInputElement;
      t1 = C.JSString_methods.$add("#", J.get$value$x(this.radio_0));
      disabledNumberInputElement = document.querySelector(t1);
      for (t1 = $.inputs, t1 = t1.get$iterator(t1); t1.moveNext$0();)
        J.set$disabled$x(t1._current, false);
      t1 = J.getInterceptor$x(disabledNumberInputElement);
      t1.set$value(disabledNumberInputElement, "");
      t1.set$disabled(disabledNumberInputElement, true);
    }
  },
  main_closure0: {
    "^": "Closure:18;",
  ...
  main_closure3: {
    "^": "Closure:18;",
    call$1: function(e) {
      var t1, selectedRate, r;
      if (C.JSArray_methods.contains$1([88, 89, 90, 84], J.get$keyCode$x(e))) {
        e.preventDefault();
        t1 = e.keyCode;
        if (t1 === 88)
          selectedRate = "d___x";
          ...
          selectedRate = t1 === 84 ? "d___theta" : null;
        t1 = C.JSString_methods.$add("#rad_", selectedRate);
        r = document.querySelector(t1);
        if (r != null)
          J.click$0$x(r);
      } else if (C.JSArray_methods.contains$1([78, 77], e.keyCode)) {
        e.preventDefault();
        t1 = e.keyCode;
        if (t1 === 78)
          F.flipTriangleY();
  ...
  main_closure4: {
    "^": "Closure:17;",
    call$1: function(e) {
      return F.flipTriangleX();
    }
  },
  main_closure5: {
    "^": "Closure:17;",
    call$1: function(e) {
      return F.flipTriangleY();
    }
  },
  main_closure6: {
    "^": "Closure:20;",
    call$1: function(e) {
      J.set$visibility$x(J.get$style$x(e), "visible");
      return "visible";
    }
  },
  Relationship: {
    "^": "Object;result>,dependencies<",
    static: {Relationship$: function(result, dependencies) {
        var t1 = new F.Relationship(result, null);
        t1.dependencies = P.LinkedHashSet_LinkedHashSet$from(dependencies, null);
        return t1;
      }}
  }
},
...
$.ctx = null;
$.triangleCoords = null;
$.interpolateCoords = null;
$.angleArcX = null;
$.angleArcY = null;
$.angleArcRadius = null;
$.angleArcStartAngle = null;
$.angleArcEndAngle = null;
$.angleArcAnticlockwise = null;
$.previousTimestamp = 0;
$.delta = 0;
...
Isolate.$lazy($, "RELATION_DATABASE", "RELATION_DATABASE", "get$RELATION_DATABASE", function() {
  return P.LinkedHashMap_LinkedHashMap$_literal([F.Relationship$(F.d("z"), ["x", "y", F.d("x"), F.d("y")]), new F.closure(), F.Relationship$(F.d("y"), ["z", "x", F.d("z"), F.d("x")]), new F.closure0(), F.Relationship$(F.d("x"), ["z", "y", F.d("z"), F.d("y")]), new F.closure1(), F.Relationship$(F.d("z"), ["y", "theta", F.d("y"), F.d("theta")]), new F.closure2(), F.Relationship$(F.d("y"), ["z", "theta", F.d("z"), F.d("theta")]), new F.closure3(), F.Relationship$(F.d("theta"), ["y", "z", F.d("y"), F.d("z")]), new F.closure4(), F.Relationship$(F.d("z"), ["x", "theta", F.d("x"), F.d("theta")]), new F.closure5(), F.Relationship$(F.d("x"), ["z", "theta", F.d("z"), F.d("theta")]), new F.closure6(), F.Relationship$(F.d("theta"), ["x", "z", F.d("x"), F.d("z")]), new F.closure7(), F.Relationship$(F.d("x"), ["y", "theta", F.d("y"), F.d("theta")]), new F.closure8(), F.Relationship$(F.d("y"), ["x", "theta", F.d("x"), F.d("theta")]), new F.closure9(), F.Relationship$(F.d("theta"), ["x", "y", F.d("x"), F.d("y")]), new F.closure10()], null, null);
});
...
{func: "dynamic__RadioButtonInputElement", args: [W.RadioButtonInputElement]},
