...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    }, null, "get$noSuchMethod", 2, 0, null, 30],
    "%": "CanvasGradient|CanvasPattern|DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|WebGLRenderingContext"
  },
  JSBool: {
    "^": "Interceptor;",
...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  _Deserializer: {
    ...
    }, "call$1", "get$deserialize", 2, 0, 2, 34],
...
["_js_helper", "dart:_js_helper", , H, {
  ...
  }, null, null, 14, 0, null, 35, 36, 37, 38, 39, 40, 41],
...
["dart.async", "dart:async", , P, {
  ...
  }, "call$1", "_nullDataHandler$closure", 2, 0, 22, 43],
  ...
  }, null, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 7, 44, 45, 46],
  ...
  _Future: {
    ...
    }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 7, 44, 45, 46],
  ...
  _Future__chainForeignFuture_closure0: {
    ...
    }, "call$1", null, null, null, 2, 2, null, 44, 45, 46, "call"]
  },
  ...
  _Future__propagateToListeners_handleValueCallback: {
    ...
    call$0: function() {
      ...
      try {
        this.box_1.listenerValueOrError_2 = this.zone_5.runUnary$2(this.listener_3.get$_async$_onValue(), this.sourceValue_4);
        return true;
      } catch (exception) {
        t1 = H.unwrapException(exception);
        e = t1;
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 11, 45, 46],
...
["dart.collection", "dart:collection", , P, {
  ...
  }, "call$1", "_defaultHashCode$closure", 2, 0, 24, 52],
...
["dart.dom.html", "dart:html", , W, {
  ...
  Element: {
    ...
    }, "createFragment$2$treeSanitizer", null, null, "get$createFragment", 2, 5, null, 44, 44],
  ...
  _Html5NodeValidator: {
    ...
    static: {_Html5NodeValidator$: function(uriPolicy) {
        ...
        return true;
      }, "call$4", "_Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 27, 49, 53, 43, 54], _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
        var t1, t2, t3, t4, t5;
        ...
        if (!t1)
          ...
          t1 = true;
        return t1;
      }, "call$4", "_Html5NodeValidator__uriAttributeValidator$closure", 8, 0, 27, 49, 53, 43, 54]}
  },
  ImmutableListMixin: {
    "^": "Object;",
    get$iterator: function(receiver) {
...
["dart.js", "dart:js", , P, {
  ...
  }, "call$1", "_convertToDart$closure", 2, 0, 28, 60],
...
["firebase.firebase", "package:firebase/src/firebase.dart", , V, {
  "^": "",
  Firebase: {
    "^": "Query;_onAuth,_onDisconnect,_fb,_onValue,_onChildAdded,_onChildMoved,_onChildChanged,_onChildRemoved",
    toString$0: function(_) {
  ...
  Firebase_set_closure: {
    "^": "Closure:2;this_0,c_1",
    call$1: [function(err) {
      this.this_0._resolveFuture$3(this.c_1, err, null);
    }, null, null, 2, 0, null, 61, "call"]
  },
  Query: {
    "^": "Object;",
    _createStream$1: function(type) {
      var t1, jsFunc, controller;
      t1 = {};
      t1.controller_0 = null;
      jsFunc = P._convertDartFunction(new V.Query__createStream_addEvent(t1), true);
      controller = H.setRuntimeTypeInfo(new P._SyncBroadcastStreamController(new V.Query__createStream_startListen(this, type, new P.JsFunction(jsFunc)), new V.Query__createStream_stopListen(this, type), 0, null, null, null, null), [Z.Event]);
  ...
  Query__createStream_addEvent: {
    ...
    call$3: [function(_, snapshot, prevChild) {
      var t1 = this.box_0.controller_0;
      if (!t1.get$_mayAddEvent())
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1(new Z.Event(new Y.DataSnapshot(snapshot), prevChild));
    }, function(_, snapshot) {
      return this.call$3(_, snapshot, null);
    }, "call$2", null, null, null, 4, 2, null, 44, 47, 62, 63, "call"]
  },
  Query__createStream_startListen: {
    "^": "Closure:1;this_1,type_2,jsFunc_3",
    call$0: function() {
      this.this_1._fb.callMethod$2("on", [this.type_2, this.jsFunc_3]);
    }
  },
  Query__createStream_stopListen: {
    "^": "Closure:1;this_4,type_5",
    call$0: function() {
      this.this_4._fb.callMethod$2("off", [this.type_5]);
    }
  }
}],
["firebase.snapshot", "package:firebase/src/data_snapshot.dart", , Y, {
  ...
  DataSnapshot_forEach_closure: {
    "^": "Closure:2;cb_0",
    call$1: [function(obj) {
      this.cb_0.call$1(new Y.DataSnapshot(obj));
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, roomName, s, t2;
    t1 = $.get$context();
    roomName = t1.callMethod$2("prompt", ["Please enter a room name!"]);
    if (roomName == null) {
      window.alert("Bye!");
      return;
    }
    s = J.replaceAll$2$s(roomName, ".", "");
    H.checkString("");
    ...
    if (s.length === 0)
      s = " ";
    document.querySelector("#roomName").textContent = s;
    t1 = P.JsObject_JsObject(J.$index$asx(t1, "Firebase"), ["https://jpl-painter.firebaseio.com/"]);
    $.mainFirebase = new V.Firebase(null, null, t1, null, null, null, null, null);
    t1 = new V.Firebase(null, null, t1.callMethod$2("child", [s]), null, null, null, null, null);
    $.roomFirebase = t1;
    t2 = t1._createStream$1("value");
    t1._onValue = t2;
    t1 = t2;
    t1.listen$1(new F.main_closure());
    t1 = document.querySelector("#artboard");
    $.canvas = t1;
    ...
    $.brushInfo = document.querySelector("#brushInfo");
    F.setBrushSize($.brushSize);
    t1 = document.querySelector("#colorSelector");
    $.colorSelector = t1;
    t1 = J.get$onInput$x(t1);
    ...
    t1 = J.get$value$x($.colorSelector);
    J.set$fillStyle$x($.ctx, t1);
    J.set$backgroundColor$x($.brush.style, t1);
    t1 = J.get$onMouseDown$x($.canvas);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.canvasMouseDown$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseUp$x($.canvas);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.canvasMouseUp$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseMove$x($.canvas);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.canvasMouseMove$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#plus"));
    ...
    t1 = J.get$onClick$x(document.querySelector("#minus"));
    ...
    t1 = J.get$onClick$x(document.querySelector("#fill"));
    ...
    t1 = document.querySelector("#save a");
    $.saveButton = t1;
    ...
    t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "contextmenu", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure6()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  paint: function(p) {
    ...
    if (typeof t4 !== "number")
      return t4.$sub();
    J.fillRect$4$x(t1, t2 - t3 / 2, t4 - t5 / 2, t5, t5);
  },
  fillCanvas: function() {
    J.fillRect$4$x($.ctx, 0, 0, J.get$width$x($.canvas), J.get$height$x($.canvas));
    $.roomFirebase.$set$1(J.toDataUrl$0$x($.canvas));
  },
  setBrushSize: function(size) {
    $.brushSize = size;
    J.set$width$x($.brush.style, "" + size);
    J.set$height$x($.brush.style, "" + $.brushSize);
    F.centerBrush();
    J.set$innerHtml$x($.brushInfo, "Brush Size: " + C.JSInt_methods.toString$0($.brushSize));
  },
  ...
  centerBrush: function() {
    ...
    if (typeof t2 !== "number")
      return t2.$sub();
    J.set$left$x(t1, C.JSNumber_methods.toString$0(t2 - t3 / 2));
    t3 = $.brush.style;
    t2 = $.get$mousePoint();
    t2 = t2.get$y(t2);
    t1 = $.brushSize;
    if (typeof t2 !== "number")
      return t2.$sub();
    J.set$top$x(t3, C.JSNumber_methods.toString$0(t2 - t1 / 2));
  },
  canvasMouseDown: [function(e) {
    var t1 = J.get$offset$x(e);
    $.mousePoint = t1;
    $.isDrawing = true;
    F.paint(t1);
  }, "call$1", "canvasMouseDown$closure", 2, 0, 29, 33],
  canvasMouseUp: [function(e) {
    $.isDrawing = false;
    $.roomFirebase.$set$1(J.toDataUrl$0$x($.canvas));
  }, "call$1", "canvasMouseUp$closure", 2, 0, 29, 33],
  canvasMouseMove: [function(e) {
    ...
    if ($.isDrawing)
      F.paint(t1);
    F.centerBrush();
  }, "call$1", "canvasMouseMove$closure", 2, 0, 29, 33],
  main_closure: {
    "^": "Closure:17;",
    call$1: [function(data) {
      var obj, val, e, t1, t2;
      data.get$snapshot();
      obj = data.get$snapshot()._ds.callMethod$1("val");
      val = C.JsonCodec_null_null.decode$1(J.$index$asx($.get$context(), "JSON").callMethod$2("stringify", [obj]));
      if (val != null) {
        e = document.createElement("img", null);
        t1 = J.getInterceptor$x(e);
        t2 = t1.get$onLoad(e);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.main__closure(e)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
        t1.set$src(e, val);
      }
    }, null, null, 2, 0, null, 50, "call"]
  },
  main__closure: {
    "^": "Closure:18;canvasData_0",
    call$1: [function(e) {
      J.drawImage$3$x($.ctx, this.canvasData_0, 0, 0);
    }, null, null, 2, 0, null, 33, "call"]
  },
  main_closure0: {
    "^": "Closure:2;",
    call$1: [function(_) {
      var t1 = J.get$value$x($.colorSelector);
      J.set$fillStyle$x($.ctx, t1);
      J.set$backgroundColor$x($.brush.style, t1);
      return;
    }, null, null, 2, 0, null, 47, "call"]
  ...
  main_closure4: {
    "^": "Closure:2;",
    call$1: [function(_) {
      J.set$href$x($.saveButton, J.toDataUrl$0$x($.canvas));
      return;
    }, null, null, 2, 0, null, 47, "call"]
  },
  main_closure5: {
    ...
    call$1: [function(e) {
      var t1, t2;
      t1 = J.getInterceptor$x(e);
      if (t1.get$keyCode(e) === 77) {
        t1 = J.get$display$x($.toolsPanel.style);
        t2 = $.toolsPanel;
        if (t1 === "none")
          J.set$display$x(t2.style, "block");
        else
          J.set$display$x(t2.style, "none");
      } else if (t1.get$keyCode(e) === 67)
        J.click$0$x($.colorSelector);
      else if (t1.get$keyCode(e) === 221)
        F.setBrushSize($.brushSize + 1);
      else if (t1.get$keyCode(e) === 219)
        F.decreaseBrushSize();
      else if (t1.get$keyCode(e) === 88)
        F.fillCanvas();
      else if (t1.get$keyCode(e) === 83) {
        J.set$href$x($.saveButton, J.toDataUrl$0$x($.canvas));
        J.click$0$x($.saveButton);
      }
    }, null, null, 2, 0, null, 33, "call"]
  },
  main_closure6: {
...
Isolate.$lazy($, "mousePoint", "mousePoint", "get$mousePoint", function() {
  var t1, t2;
...
{func: "dynamic__Event0", args: [W.Event0]},
